...
extern "C" {
#endif
void  rmaPropagate0_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_proc2_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_proc2_vcs_daidir (UB  * pcode, scalar  val);
